...
const topSKUs = [
  { sku: "SKU-2847", name: "Wireless Headphones Pro", category: "Electronics", demand: 847, stock: 234, risk: "High", days: 3 },
  { sku: "SKU-1923", name: "Running Shoes Elite", category: "Sports", demand: 623, stock: 412, risk: "Medium", days: 8 },
  { sku: "SKU-5621", name: "Smart Watch Series 5", category: "Electronics", demand: 534, stock: 89, risk: "High", days: 2 },
  { sku: "SKU-8234", name: "Yoga Mat Premium", category: "Sports", demand: 412, stock: 567, risk: "Low", days: 16 },
  { sku: "SKU-4729", name: "Coffee Maker Deluxe", category: "Home & Garden", demand: 389, stock: 145, risk: "Medium", days: 5 },
  { sku: "SKU-9156", name: "Designer Sunglasses", category: "Apparel", demand: 356, stock: 78, risk: "High", days: 3 },
  { sku: "SKU-3482", name: "Bluetooth Speaker", category: "Electronics", demand: 298, stock: 423, risk: "Low", days: 18 },
  { sku: "SKU-7821", name: "Kitchen Knife Set", category: "Home & Garden", demand: 267, stock: 312, risk: "Low", days: 14 },
];
      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>6-week prediction with historical comparison</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-[280px]">
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={forecastData}>
                    ...
                    <Tooltip />
                    <Legend />
                    <Line type="monotone" dataKey="actual" stroke="#0d9488" strokeWidth={3} name="Actual" />
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Number of SKUs at risk in each category</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-[280px]">
                <ResponsiveContainer width="100%" height="100%">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Items requiring attention based on forecasted demand and current stock</CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b">
                    ...
                    <th className="text-right pb-3 text-sm">Predicted Demand</th>
                    <th className="text-right pb-3 text-sm">Current Stock</th>
                    <th className="text-right pb-3 text-sm">Days to Stock-Out</th>
                ...
                <tbody>
                  {topSKUs.map((item) => (
                    <tr key={item.sku} className="border-b hover:bg-slate-50">
                      ...
                      <td className="py-3 text-sm text-right">{item.days} days</td>
                      <td className="py-3 text-right">
                        <Badge 
                          variant="outline" 
                          className={
                            item.risk === "High" ? "text-red-600 border-red-200 bg-red-50" :
                            item.risk === "Medium" ? "text-orange-600 border-orange-200 bg-orange-50" :
        ...
        <div className="rounded-lg border border-orange-200 bg-orange-50 p-4">
          <div className="flex gap-3">
            ...
            <div>
              <p className="text-sm">
                <span className="font-medium">Action Required:</span> 3 high-priority SKUs need immediate reorder
              </p>
              <p className="text-xs text-muted-foreground mt-1">
                SKU-2847, SKU-5621, and SKU-9156 are predicted to stock out within 3 days. Review recommended order quantities.
              </p>
            </div>
          </div>
        </div>
