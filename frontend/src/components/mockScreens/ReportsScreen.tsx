...
export function ReportsScreen() {
  ...
  const reportSections = [
    ...
    },
    {
      ...
      description: "Customer retention and churn risk assessment",
    },
    {
      id: "sales-forecast",
      label: "Sales Forecast",
      description: "30-day sales predictions and trends",
    },
    {
      id: "inventory-risk",
      label: "Inventory Risk Summary",
      description: "Stock-out risk and reorder recommendations",
    },
    {
      id: "recommended-actions",
      label: "Recommended Actions",
      description: "AI-generated action items and insights",
    },
  ];
  ...
  const recentReports = [
    {
      name: "Customer Analytics Report - March 2025",
      date: "2025-03-15",
      type: "PDF",
      status: "Ready",
    },
    {
      name: "Inventory Forecast - Q1 2025",
      date: "2025-03-10",
      type: "PowerPoint",
      status: "Ready",
    },
                    ...
                    <div className="text-center space-y-2">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-xs text-muted-foreground">
                          Demo Store • {new Date().toLocaleDateString()}
                        </p>
                        <p className="text-xs text-muted-foreground">
                          {selectedSections.length} sections included
                        </p>
                      </div>
                    </div>
                  </div>
